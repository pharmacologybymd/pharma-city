...
Across the black canal sits Anticholinergic Alley: a bone-dry desert quarter where the fountains have all been sealed. No saliva, no tears, no sweat, no bowel sounds — only a fast hollow pulse and pupils wide as dinner plates. Atropine's tower stands at the centre of the alley like an obelisk, its stone carved with the words "dry as a bone, blind as a bat, red as a beet, hot as a hare, mad as a hatter." The two halves of the district are mirror images of each other, and knowing one perfectly is knowing both.`,
  ...
  drugs: [
...

    {
      ...
      mechanism: 'Binds muscarinic receptors (M1–M5) at parasympathetic effector organs and CNS, and nicotinic receptors (NM at NMJ, NN at autonomic ganglia). Hydrolysed rapidly by acetylcholinesterase (AChE) and butyrylcholinesterase at the synapse, making its systemic duration of action extremely short.',
    ...
    },
    {
      ...
      clinical_use: 'Antidote for anticholinergic toxidrome (atropine poisoning, tricyclic antidepressant overdose — used cautiously); topical ophthalmic use (historical: glaucoma); post-anaesthesia central anticholinergic syndrome.',
    ...
    },
    {
      ...
      mechanism: 'Blocks M1 muscarinic receptors in the vestibular nuclei and nucleus of the solitary tract, reducing the emetic response to vestibular input. Also blocks M1/M4 receptors in the CNS → sedation, amnesia, antiemetic effect. Tertiary amine: readily crosses BBB. Transdermal patch delivers controlled release over 72 hours.',
    ...
    },
    {
      ...
      mechanism: 'Blocks M3 and M4 muscarinic receptors on the iris sphincter and ciliary muscle of the eye → mydriasis (pupil dilation) and cycloplegia (paralysis of accommodation). Shorter duration than atropine (~4–6 hours vs. 1–2 weeks) owing to lower affinity for the receptors and faster dissociation.',
