const DISTRICT_AUTACOIDS = {
  ...
  drugs: [
    ...
    },
    {
      ...
      mechanism: 'Blocks H1 receptors peripherally and centrally. Potent anticholinergic (antimuscarinic) properties. Also antagonises muscarinic receptors in the vestibular nuclei (anti-emetic, motion sickness). Crosses BBB readily — sedation is marked. Dopamine D2 receptor weak blockade contributes to anti-Parkinsonian (anti-tremor) activity in drug-induced parkinsonism.',
    ...
    },
    {
      ...
      class: 'PGE1 analogue (synthetic); prostaglandin receptor agonist (EP1, EP3)',
